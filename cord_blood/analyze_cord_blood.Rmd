...
* `r round(100*length(unique(cord_blood_kinases$barcode))/length(unique(cord_blood_filt$barcode)))`% of the cells express at least one kinase
...
I've also figured out how many cells express each given kinase. For reference, there are `r length(unique(cord_blood_filt$barcode))` cells in the data set.
